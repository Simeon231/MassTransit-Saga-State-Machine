...
namespace MassTransitSaga.CDK
{
    public class DemoStack : Stack
    {
        public DemoStack(Construct scope, string id, IStackProps? props = null) : base(scope, id, props)
        {
            ...
            var cluster = new Cluster(this, "MassTransitSagaCluster", new ClusterProps
            {
                Vpc = vpc,
            });

            CreateApp(this, cluster, "Inventory", "./MassTransitSaga.Inventory/Dockerfile", 80);

            CreateApp(this, cluster, "Payment", "./MassTransitSaga.Payment/Dockerfile", 80);

            CreateApp(this, cluster, "Orders", "./MassTransitSaga.Orders/Dockerfile", 80);
        }
